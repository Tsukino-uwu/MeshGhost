...
**Running the scaffolding, the dev rigs, BizHawk from PowerShell, several agents at once, crash dumps and
...
### Attaching, swapping and reloading scripts
...
### Savestates, screenshots, input, cheats and ROM swaps
...
### How to use it: iterate freely, then hand over ONE confirmation
...
### Working habits the capabilities demand
