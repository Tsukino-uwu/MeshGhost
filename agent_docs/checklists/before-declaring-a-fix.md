...
- A cache with an invalidation comment and no invalidation (Crystal, 2026-08-25) — [by-lesson.md](../pitfalls/by-lesson.md)
...
- A refusal applies to EVERY caller: before adding one to an existing function, list its callers and ask which must not be refused — a relay-id gate in shared code would have deleted every replay and chaser ghost (core, 2026-09-12) — [method.md](../pitfalls/method.md)
