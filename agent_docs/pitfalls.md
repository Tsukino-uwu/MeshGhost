...
**This file has two structures, and both work.** Lines 582-1573 group by **host/subsystem** —
reach for that when you know what you are touching. Everything after is **chronological** and
lesson-shaped, cutting across hosts; the titles are the lessons, which is why an index over them
is worth more than re-filing them. **Nothing here is re-filed; this index is added over both.**

Maintained by adding ONE line when you add an entry. `dev-scripts/preflight.ps1` checks that
every heading appears here — a taxonomy cannot be checked that way, which is why this is an
index. Added 2026-08-25.

### Method, and instruments that lie (top of file)
...
### By host and subsystem (lines 582-1573)
...
### By lesson, in the order they were found (line 1574 onward)
...
**These themed sections cover about a fifth of the file; the rest is chronological, and that is
deliberate.** Resolved 2026-08-25: this is not one taxonomy left half-done, it is two organising
...
beats re-filing them. **The index at the top of this file covers both halves** — use it rather than
