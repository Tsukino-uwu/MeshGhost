...
- 2026-09-17 — **Autoplay (Phase 13): Phase 1 DONE, at its CHECKPOINT** (Emerald: a new game to MAY's battle walked, one run log); next: Phase 2, `goto` across maps. Crystal (its own chat): position, mode, `walk`, text and menus on vanilla V1.0; next a battle. `phases/phase13.md`.
