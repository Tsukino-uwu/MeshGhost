...
- 2026-09-15 — **PARKED, the user's call: measure whether quic's congestion controller paces datagrams late after a loss** (the 2026-09-02 bike glide); instrument, run matrix and decision rule written in `ideas.md`. GameNetworkingSockets considered and declined the same day, `licensing.md`.
