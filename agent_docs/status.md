...
- 2026-09-23 — **Every adapter README's "roughly in order" build story: a stale sweep** -- it drifts despite the checks (the user); Pseudoregalia likely skips steps between 70 and 71. Fact-check against the code.
