...
- 2026-09-05 — **The recording indicator is built and mostly confirmed; its LAST BUILD IS NOT DEPLOYED** (the game was running). Deploy, then judge four numbers — all live-tunable via `dlls/rec_indicator.txt` — `adapters/pseudoregalia/UNVERIFIED.md`.
