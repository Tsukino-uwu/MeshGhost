...
- 2026-09-16 — **Autoplay (Phase 13): Phase 1, steps 1-10 done** (Emerald: text, map, save, cheats, battles, a trainer, run and bikes); next: bike turns, a `goto`. `phases/phase13.md`.
