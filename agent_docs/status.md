...
- 2026-09-13 — **Pseudoregalia: v1.2.9's stranded-materials fix REGRESSED (a peer's outfit swap reaches other players) and is REVERTED, not yet released.** `pseudoregalia/UNVERIFIED.md`.
