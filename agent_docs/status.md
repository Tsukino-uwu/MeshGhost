...
- 2026-09-17 — **Autoplay (Phase 13): Phase 1, steps 1-13 done** (Emerald: text, save, cheats, bikes, `goto` around trainers' sight, one-call battles, the bag); next: a new game to the first trainer. Crystal started in another chat. `phases/phase13.md`.
