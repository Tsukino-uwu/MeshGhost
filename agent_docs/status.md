...
- 2026-09-16 — **Autoplay (Phase 13): Phase 1 underway** — the core answers over MCP (tested, no game yet); next the BizHawk driver on vanilla Emerald. `phases/phase13.md`.
