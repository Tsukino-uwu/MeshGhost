...
- 2026-09-16 — **Autoplay (Phase 13): Phase 1, steps 1-3 done** (core over MCP, a live Emerald driver, snapshots, warp, walked/reached run log); next: text and menus, then the rest of Phase 1. `phases/phase13.md`.
