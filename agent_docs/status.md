...
- 2026-09-16 — **Autoplay (Phase 13): Phase 1, steps 1-11 done** (Emerald: text, save, cheats, bikes, `goto`, one-call battles); next: sight lines, bag menus, a new game. `phases/phase13.md`.
