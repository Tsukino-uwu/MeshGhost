...
- 2026-09-16 — **Autoplay (Phase 13): Phase 1, steps 1-8 done** (Emerald: text, map, save, cheats, wild battles); next: a trainer battle, the acceptance run. `phases/phase13.md`.
