...
- 2026-09-05 — **RESET TO LAST SAVE while RECORDING crashed the game (03:56); the indicator's components are now DESTROYED at the reset button, built and deployed, UNWATCHED** — the fourth handle in the reset-crash family, promoted to a rule: `checklists/before-spawning-in-unreal.md`; `pseudoregalia/UNVERIFIED.md`.
