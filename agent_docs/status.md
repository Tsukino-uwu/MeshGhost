...
- 2026-09-05 — **The recording indicator is built, deployed and mostly confirmed; four numbers left to judge** — all live-tunable via `dlls/rec_indicator.txt` — `adapters/pseudoregalia/UNVERIFIED.md`.
