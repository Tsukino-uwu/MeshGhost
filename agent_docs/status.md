...
- 2026-09-05 — **RESET TO LAST SAVE crashed twice (03:56, 04:15), reproducible by spamming the pause menu first; the cause is the reset hook's own destroy-at-click, which only ever ARMED by accident — the hook is OBSERVE-ONLY by default now, built and deployed, UNWATCHED** — rule: `checklists/before-spawning-in-unreal.md`; `pseudoregalia/UNVERIFIED.md`.
