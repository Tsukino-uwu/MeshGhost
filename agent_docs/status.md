...
- 2026-09-17 — **Autoplay, Emerald: the scenario runner BUILT** (RICK's sight 3 of 3, no model); next: recover a finished message after a restore, keyboard/clock/bag readers, `exec`, noclip. `phases/phase13.md`.
- 2026-09-17 — **Autoplay, Crystal (its own chat)**: battlers, `walk`, `select`, `advance_text`, `battle strongest` and `run` on V1.0; next a trainer battle (Route 30), then the PACK's list. `phases/phase13.md`.
