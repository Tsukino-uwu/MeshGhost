...
- 2026-09-17 — **Autoplay (Phase 13): Phase 1, steps 1-12 done** (Emerald: text, save, cheats, bikes, `goto` around trainers' sight, one-call battles); next: bag menus, a new game. Crystal started in another chat. `phases/phase13.md`.
