...
- 2026-09-16 — **Autoplay (Phase 13): Phase 1, steps 1-6 done** (Emerald: text, menus, map, `walk`, party/bag/badges, item and flag cheats); next: a stale menu window, list menus, battle text. `phases/phase13.md`.
