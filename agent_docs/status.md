...
- 2026-09-04 — **OPEN, user-reported:** a replay ghost shows the Dream Breaker on a save that has not picked it up. The show/hide path is ruled out by reading; the suspect is what `weaponEquipped?` MEANS before the pickup — `adapters/pseudoregalia/UNVERIFIED.md`.
