...
- 2026-09-17 — **Autoplay, Emerald: the scenario runner BUILT** (RICK's sight 3 of 3, no model); next: the clock reader (measured), the starter bag, `exec`, noclip. `phases/phase13.md`.
