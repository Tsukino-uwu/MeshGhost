...
- 2026-09-16 — **Autoplay (Phase 13): Phase 1, steps 1-5 done** (MCP core, Emerald driver, snapshots, warp, run log, text, menus, `select`, local map, `walk`); next: party/bag/badges, cheats. `phases/phase13.md`.
