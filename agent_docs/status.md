...
- 2026-09-02 **The post-review run is DONE on Crystal and Emerald (both changed on the day, see their queues); TEVI and Pseudoregalia still need theirs** — each queue's "This run" block; ADR 0044.
