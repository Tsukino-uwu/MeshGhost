...
- 2026-09-16 — **Emerald: a spawned ghost is written into the player's in-game save and returns on Continue** (measured; a map load clears it). The fix is the user's call. `emerald/UNVERIFIED.md`, top.
- 2026-09-16 — **Borrowed VALUES in adapter code: Crystal's three MEASURED and matching (the shadow's up-hop aside); Emerald's six open**, each an UNVERIFIED question. `phases/phase12.md`.
