...
- 2026-09-16 — **Autoplay (Phase 13): Phase 1, steps 1-4 done** (MCP core, Emerald driver, snapshots, warp, run log, dialogue, menus, `select`); next: ASCII map, party/bag/badges, cheats. `phases/phase13.md`.
