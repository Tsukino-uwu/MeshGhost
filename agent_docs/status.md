...
- **Crystal: the drawn ghost wears the SURF sprite on land, walking DOWN only (2026-08-25)** — a
  live user report. Two code theories refuted; `MESHGHOST_CRYSTAL_SPRITE_TRACE` is built, unrun. `crystal/UNVERIFIED.md`.
