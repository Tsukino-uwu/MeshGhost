...
which tests negative alone. Full text in the archive at the end of this file; evidence in
...
open (ADR, `architecture.md`). Full text in the archive at the end of this file.
...
half-done idea reads as done. Full original text in the archive at the end of this file.
