...
-- adapters/emerald/phase3_loopback.lua (state reading, screen-position anchor, JSON,
...
--
-- State reading: same addresses as adapters/emerald/phase1_probe.lua (gSaveBlock1Ptr,
-- gPlayerAvatar, gObjectEvents), same pokeemerald citations, not re-derived here.
-- Screen-position anchor: same formula as adapters/emerald/phase2_ghost.lua (gSprites,
...
-- (src/overworld.c L1484). Confirmed live (2026-08-11, adapters/emerald/battle_probe.lua) the
