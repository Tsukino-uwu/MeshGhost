...
-- adapters/pokemon/emerald/phase3_loopback.lua (state reading, screen-position anchor, JSON,
...
-- (src/overworld.c L1484). Confirmed live (2026-08-11, adapters/pokemon/emerald/battle_probe.lua) the
