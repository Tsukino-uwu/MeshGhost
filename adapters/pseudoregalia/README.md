...
All of this is one phase, `agent_docs/phases/phase7.md` — the sub-numbers below (7.1, 7.4,
...
See `agent_docs/phases/phase7.md` for the detailed, dated log, and `agent_docs/pitfalls.md`
for the transferable lessons pulled out of this saga (auto-possession on spawn, camera/view-target
