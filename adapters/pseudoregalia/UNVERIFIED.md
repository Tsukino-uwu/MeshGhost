...
- READY — **the recording indicator is a SCREEN-SPACE widget now (build `57fba63a04e6`): built once per recording, handles valid on the tick they were made, removed on stop -- in your 15:16 screenshot at 0:00. Yours to say: it looks like the ShareX-checked prototype and keeps its time across a zone change.**
