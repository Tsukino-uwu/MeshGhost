...
--     non-blocking pattern adapters/pokemon/emerald/phase5_5_sprite.lua already uses for the
...
-- implementation (adapters/pokemon/emerald/phase5_5_sprite.lua) -- plain Lua string/table
...
----------------------------------------------------------------------------
-- Minimal JSON -- ported from adapters/pokemon/emerald/phase5_5_sprite.lua, already proven
