-- MeshGhost — Pokémon Crystal: spawn test 6, NPC template PLUS computed screen coordinates
--
...
--      Log: spawn_test6_<timestamp>.log beside this script.
...
local function open_log()
	...
	logfile = io.open(string.format("%s/spawn_test6_%s.log", dir, os.date("%Y%m%d_%H%M%S")), "w")
...
open_log()
log("=== MeshGhost Crystal spawn test 6 — NPC template + computed screen coords (WRITES RAM) ===")
