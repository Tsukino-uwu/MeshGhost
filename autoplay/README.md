...
- **`menu`** — the menu waiting for input: `items` in order and `cursor`, 0-based. The START menu and a
  ...
  `accuracy`, `same_type`; the move to learn last). The bag inside a battle, the party menu and other lists (the PC, shops)
