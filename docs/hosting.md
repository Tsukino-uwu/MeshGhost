...
for forwarding it, and no program on this machine can see your router anyway; what the relay does
give you is the `to accept players from outside this machine, forward:` line in its startup log,
which lists the
