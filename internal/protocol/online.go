...
// all as opaque to internal/relay as area_id and anim already are. Authority
...
// key — internal/relay has its own MaxHelloFieldLen for Hello's fields, and
// this exists in protocol/ because internal/core needs the same bound on the
// values it sends.
...
// internal/core.reconnectWithBackoff's first few attempts (1s, 2s, 4s, 8s)
