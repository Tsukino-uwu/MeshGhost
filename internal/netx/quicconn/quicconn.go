...
// ordinary net.Conns, the same shape internal/netx/udpconn provides for
// UDP, so internal/relay and internal/transport need no knowledge of it.
//
...
const (
	...
	// internal/transport's own generous default rather than
	// internal/protocol's tighter one, because this package deliberately
...
// only a net.Conn. See the equivalent in internal/netx/udpconn.
